...
///создаем свойство для прямого доступа к анимации игрока			
...
///соединение с другими игроками
 ...
 /////////////////////////////////////////////////////////////////////////////////////////// 
		...
		///создаем новых игроков		
		 for(var key in data){		 
			 if(data[key].id != userId){
				...
				addTileCommon(data[key].id, HM.$props().sprites[modules.personage.parent], data[key].point);                				 
			 }			 
		 }
  ...
  var interval = setInterval(function() {
    ...
    socket.send('coord', {id: userId, point: modules.personage.point, frame_index: modules.personage.frame_index, msg: modules.personage.message});
  }, 100);
